function [transformed,origPts,destPts]=simpleTransform(I,option)
%I=imread('cam.bmp');
if size(I,3)>1
    I=rgb2gray(I);
end
...
[destPts]=getTiePoints(4,I);

origPts=[1 1;size(I,2) 1;1 size(I,1);size(I,2) size(I,1)];
...
imwrite(transformed,'distorted.bmp');
